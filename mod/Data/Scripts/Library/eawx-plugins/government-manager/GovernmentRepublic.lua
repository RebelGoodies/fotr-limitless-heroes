...
function GovernmentRepublic:GC_AI_Republic_Future()
	...
	if enabled == true then
		...
		UnitUtil.SetLockList("EMPIRE", {"Yularen_Resolute_Upgrade_Invincible", "Yularen_Integrity_Upgrade_Invincible","Tarkin_Executrix_Upgrade"})

		UnitUtil.ReplaceAtLocation("Anakin", "Vader_Team")
		UnitUtil.ReplaceAtLocation("Anakin2", "Vader_Team")

		StoryUtil.SpawnAtSafePlanet("CORUSCANT", Find_Player("Empire"), StoryUtil.GetSafePlanetTable(), {"Emperor_Palpatine_Team","Mulleen_Imperator"})
